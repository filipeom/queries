...
(declare-fun e i32)
(declare-fun f i32)
(assert (bool.not (i32.eq (i32.and (i32.of_bool (i32.le_s f (i32 3))) (i32 1)) (i32 0))))
(assert (i32.eq (i32.and (i32.of_bool (i32.le_s e (i32 3))) (i32 1)) (i32 0)))
(assert (i32.eq (i32.and (i32.of_bool (i32.le_s d (i32 3))) (i32 1)) (i32 0)))
