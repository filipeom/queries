; unsat
(declare-fun n i32)
(assert (bool.not (i32.to_bool (i32.and (i32.of_bool (i32.lt_u (i32 2) n)) (i32 1)))))
(assert (bool.not (i32.eq (i32.and (i32.of_bool (i32.eq (i32.add (i32 66640) (i32 0)) (i32.add (i32 66640) (i32 0)))) (i32 1)) (i32 0))))
(assert (i32.eq (i32.and (i32.of_bool (i32.eq (i32.add (i32 66636) (i32 0)) (i32.add (i32 66640) (i32 0)))) (i32 1)) (i32 0)))
(assert (i32.eq (i32.and (i32.of_bool (i32.lt_s (i32 3) n)) (i32 1)) (i32 0)))
