...
(assert (i32.to_bool (i32.and (i32.of_bool (i32.ne (i32.add (i32 66676) (i32 0)) (i32 0))) (i32 1))))
...
(assert (bool.not (i32.eq (i32.and (i32.of_bool (i32.lt_s d b)) (i32 1)) (i32 0))))
...
(assert (i32.eq (i32.and (i32.of_bool (i32.lt_s d a)) (i32 1)) (i32 0)))
