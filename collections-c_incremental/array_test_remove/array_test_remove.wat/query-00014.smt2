; unsat
(let-const n i32)
(assert (bool.not (i32.to_bool (i32.and (i32.of_bool (i32.lt_u (i32 4) n)) (i32 1)))))
(assert (bool.not (i32.eq (i32.and (i32.of_bool (i32.eq (i32.add (i32 66648) (i32 0)) (i32.add (i32 66648) (i32 0)))) (i32 1)) (i32 0))))
(assert (i32.eq (i32.and (i32.of_bool (i32.eq (i32.add (i32 66644) (i32 0)) (i32.add (i32 66648) (i32 0)))) (i32 1)) (i32 0)))
(assert (i32.eq (i32.and (i32.of_bool (i32.eq (i32.add (i32 66640) (i32 0)) (i32.add (i32 66648) (i32 0)))) (i32 1)) (i32 0)))
(assert (i32.eq (i32.and (i32.of_bool (i32.eq (i32.add (i32 66636) (i32 0)) (i32.add (i32 66648) (i32 0)))) (i32 1)) (i32 0)))
(assert (i32.eq (i32.and (i32.of_bool (i32.lt_s (i32 5) n)) (i32 1)) (i32 0)))
