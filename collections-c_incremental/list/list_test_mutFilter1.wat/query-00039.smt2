...
(assert (bool.not (i32.to_bool (i32.and (i32.of_bool (i32.eq d (i32 0))) (i32 1)))))
...
(assert (bool.not (i32.to_bool (i32.and (i32.of_bool (i32.eq c (i32 0))) (i32 1)))))
...
(assert (bool.not (i32.to_bool (i32.and (i32.of_bool (i32.eq b (i32 0))) (i32 1)))))
...
(assert (bool.not (i32.to_bool (i32.and (i32.of_bool (i32.eq a (i32 0))) (i32 1)))))
